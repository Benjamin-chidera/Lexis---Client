      ...
      <AlertDialogContent className="w-full max-w-6xl! h-[85vh] bg-[#0a0a0a] border-white/10 rounded-[28px] shadow-[0_40px_120px_rgba(0,0,0,0.9)] flex flex-col overflow-hidden p-0 gap-0">
        ...
        <div className="relative z-10 flex items-center gap-4 px-6 py-4 border-b border-white/6 bg-[#0a0a0a]/80 backdrop-blur-xl shrink-0">
          ...
          <div className="flex-1 min-w-0">
            <AlertDialogTitle className="text-sm font-bold text-white truncate leading-tight">
              {activeCase.name}
            </AlertDialogTitle>
          ...
          <div className="relative shrink-0 ml-2 mr-2">
            <Button
              ...
              className="w-9 h-9 rounded-xl text-slate-500 hover:text-white hover:bg-white/5"
            >
        ...
        <div className="flex flex-1 overflow-hidden gap-4 p-4">
          ...
          <div className="flex flex-col flex-1 overflow-hidden gap-3">
            ...
            <div className="flex-1 overflow-hidden border border-white/5 bg-black/20 rounded-2xl">
              <CaseChatPanel
