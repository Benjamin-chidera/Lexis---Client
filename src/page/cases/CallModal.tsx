...
export const CallModal = () => {
  ...
  return (
    ...
    >
      <AlertDialogContent className="w-full max-w-6xl! h-[88vh] bg-[#0a0a0a] border-white/10 rounded-[1.75rem] shadow-[0_2.5rem_7.5rem_rgba(0,0,0,0.9)] flex flex-col overflow-hidden p-0 gap-0">
        {/* ── Modal header ── */}
        <div className="flex items-center gap-0.1875rem-6 py-4 border-b border-white/6 bg-[#0a0a0a]/90 backdrop-blur-xl shrink-0">
