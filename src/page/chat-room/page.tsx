...
const ChatRoomPage = () => {
  return (
    <div className="h-screen bg-black overflow-hidden text-slate-200 flex flex-col font-sans  selection:bg-purple-500/30">
      ...
      {/* <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-purple-900/10 rounded-full blur-[7.5rem] pointer-events-none" />
      <div className="absolute bottom-[10%] right-[-5%] w-[30%] h-[30%] bg-blue-900/5 rounded-full blur-[6.25rem] pointer-events-none" /> */}
      ...
      {/* <div className="fixed bottom-32 left-[calc(50%-7.5rem)] z-50">
        <div className="group bg-[#0a0a0a]/95 border border-white/10 p-4 pr-6 rounded-[1rem] flex items-center gap-4 backdrop-blur-2xl shadow-[0_1.875rem_3.75rem_rgba(0,0,0,0.7)] animate-in fade-in slide-in-from-bottom-10 duration-700">
          <div className="w-10 h-10 rounded-xl bg-pink-500/10 flex items-center justify-center border border-pink-500/20">
            <Search className="w-5 h-5 text-pink-400" />
          </div>
          <div>
            <h4 className="text-[0.625rem] font-black text-pink-400 uppercase tracking-widest mb-0.5">
              Deep Dig Alert
            </h4>
